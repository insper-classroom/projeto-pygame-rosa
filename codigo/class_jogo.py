        ...
        while True:
            ...
            for rect in self.leaf_spawner:
                if random.random() * 49999 < rect.width * rect.height:
                    ...
                    self.particles.append(Particle(self, 'leaf', pos, velocity=[0.01, 0.3], frame=random.randint(0, 20)))
            self.clouds.update()
            self.clouds.render(self.display, offset=render_scroll)
            self.tilemap.render(self.display, offset=render_scroll)

            for enemy in self.enemies.copy():
                enemy.atualizar(self.tilemap, (0, 0))
            ...
            for projectile in self.projectiles.copy():
                ...
                if self.tilemap.solid_check(projectile[0]):
                    ...
                    for i in range(30):
                        ...
                        self.particles.append(Particle(self, 'shot', self.player.rect().center, velocity=[math.cos(angle + math.pi) * speed * 0.5, math.sin(angle + math.pi) * speed * 0.5]))
