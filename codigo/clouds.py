...
class Cloud:
    ...
    def render(self, surf, offset=(0,0)):
        ...
        surf.blit(self.img, (render_pos[0] % (surf.get_widht() + self.img.get_width()) - self.img.get_width())), (self.img, (render_pos[1] % (surf.get_height() + self.img.get_height()) - self.img.get_height()))
